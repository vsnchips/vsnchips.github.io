...
function (_Component) {
  ...
  _createClass(AboutPage, [{
    ...
    value: function render() {
      ...
      }, "Hi, I'm Dan. I've been on the Earth since 1989. I'm a visual artist, designer, and computer graphics engineer. I began programming around 2000, using the 2D edition of blitz BASIC. My first exercises included writing a basic rasteriser for drawing and rotating 3D wireframes, and an autostereogram (magic-eye) generator."), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 28
        }
      }, "Throughout highschool I studied painting and design, while continuing to develop digital skills through music visualisation with Winamp's AVS, and mod development. In 2003 I joined the development team for 'Galactic Conquest', star wars conversion mod for battlefield 1942. I was responsible for creating maps. I especially enjoyed the overall process of look development for each world, including the painterly process of generative texturing, terrain sculpting, and color matching the dynamic light settings with the static environmental assets")));
    }
  }], [{
    key: "getInitialProps",
...
//# sourceMappingURL=5.f5dc949509ac89035ca1.hot-update.js.map